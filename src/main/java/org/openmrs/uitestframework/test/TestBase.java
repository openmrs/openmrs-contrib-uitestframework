...
public class TestBase implements SauceOnDemandSessionIdProvider {
	...
	public void launchBrowser() throws Exception {
		...
		if (isRunningOnSauceLabs()) {
			...
			driver = new RemoteWebDriver(
					new URL("http://" + sauceLabsAuthentication.getUsername() + ":"
							+ sauceLabsAuthentication.getAccessKey() + "@" + sauceLabsHubUrl + "/wd/hub"),
					capabilities);
	...
	public documentInfo createTestFileDocument() throws IOException{
		documentInfo docInfo = new documentInfo();
		docInfo.testFileDocument();
		return docInfo;
		}
